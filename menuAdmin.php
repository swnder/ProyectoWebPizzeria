...
<html lang="es" dir="ltr">
  <head>
    ...
    <script src="js/MatrialDesign.js"></script>
    <!-- Boostrap -->
            ...
            <ul class="custom-scrollbar">
              ...
              <li>
                <ul class="collapsible collapsible-accordion">
                  ...
                  <li><a class="collapsible-header waves-effect arrow-r"><i class="far fa-envelope"></i> Contact
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-4 text-center">
                        ...
                        <p>Average sales:
                          <strong>100$</strong>
                          <button type="button" class="btn btn-info btn-sm p-2" data-toggle="tooltip" data-placement="top"
                            title="Average daily sales in the given period">
                            <i class="fas fa-question"></i>
                          </button>
                        </p>
