                        ...
                        function(indice){
                            switch (indice){
                                ...
                                case 3:
                                    ...
                                    break;
                                case 4:
                                    window.opener.document.getElementById("email").value = $(this).text();
                                    break;
                                case 5:
                ...
                <div style="width:100%; height:339px; position:absolute; background:#eaf1f1; top:30px; left:0px;">
                    ...
                    <table align="center" id=bordeFino>
                        <tr class="cabecera-tabla">
                            ...
                            <td id=bordeFino width="300px">TELEFONO</td>
                            <td id=bordeFino width="120px">DIRECCION</td>
                            <td id=bordeFino width="120px">EMAIL</td>
            ...
            ';
                ...
                foreach ($resultado as $fi) {
                    echo "<tr class='detalle-tabla'>";
                        ...
                        echo "<td id=bordeFino>".$fi['nombre']."</td>";
                        echo "<td id=bordeFino>".$fi['telefono']."</td>";
                        echo "<td id=bordeFino>".$fi['direccion']."</td>";
                        echo "<td id=bordeFino>".$fi['email']."</td>";
                        echo "<td id=bordeFino>".$fi['ciudad']."</td>";
                        echo "<td id=bordeFino align=center>".$fi['id']."</td>";
