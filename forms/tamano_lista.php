 ...
 <body style="
  ...
  <div class="container bg-dark mt-5" id="tabla">
      <div class="table-responsive" >
           ...
           <h1 class="text-center mt-3">Lista de Tamaño</h1>
           <table class="table table-bordered display nowrap stripe"  id="tablaCiudad" style="width:100%">
                ...
                <tbody id="tbody">
                     <?php
                          ...
                          $conex = conexion();
                          $sql = "SELECT * FROM tamano ORDER BY id";
           ...
           <script>
             ...
             lengthMenu:				[[5, 10, 20, 50, -1], [5, 10, 20, 50, "Todos"]],
                              ...
                              // 'csvHtml5',
                               ...
                               {text:"<i class ='fa fa-plus-circle'> Nuevo</i>",
                                 ...
                                 titleAttr:'Cargar nuevo Registro', action: function (e, dt, node, config){
                      		     window.location="tamano_am.php?accion=N";
                       		}},
                        ] // fin de los botones
                     } );
                } );
                ...
                function obtenerIdEli(){
                     ...
                     alertify.confirm("Eliminar registro", "¿Desea eliminar el registro Tamano?",
                          function(){ //SI
                               eliminar(id);
                          },
                          function(){ //NO
                ...
                function eliminar(id){
                     $.ajax({
                          ...
                          if (resp == 5){
                               alertify.alert("Atención", "El registro  Tamano fue Eliminado",
                                    function(){
                                         location.reload();
                                    }
                               );
                ...
                function obtenerIdModi(){
                     ...
                     for (i=0; i<filas.length; i++) {
                          filas[i].onclick = function() {
                               ...
                               id = tabla.rows[fi].cells[0].innerHTML;
                               window.location="../forms/tamano_am.php?accion=M&id="+id;
                          }
                     }
                }
           </script>
