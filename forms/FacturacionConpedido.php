         ...
         <div class="row">
           <div class="colu">
             <div class="form-group row mt-2">
               <div class="col-12 col-md-4 mb-2 " style="width: 100px; heigth 115px, overflow:scroll;" id="tabla">
                 <h1 class="text-center mt-3  font-weight-bold">Pedidos</h1><hr>
                 <?php
                   ...
                   $res = mysqli_query($con, $sql);
                     foreach ($res as $row) {
                         echo "<div>".'Orden#: '.$row["nroPedido"].' '.'Mesa:'.$row["mesa"]."<button type='button' name='button' class='btn gris'>Elegir</button></div><br>";
                     }
                 ?>
               ...
               <div class="col-12 col-md-8 mb-2">
                 <div class="container gris">
                      <h2 class="text-center mt-3  font-weight-bold" id="titulo">Facturación</h2>
                           ...
                           <div class="col">
                                ...
                                <form id="form_pedidos" onkeypress="if(event.keyCode == 13){ event.returnValue=validarCampos();}">
                                     ...
                                     <div class="form-group row mt-2">
                                      ...
                                      <div class="col-12 col-sm-2 mt-3">
                                         <label class="font-weight-bold" for="mesa"> #Mesa</label>
