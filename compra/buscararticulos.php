    ...
    <body>
        <?php
                ...
                <div style="width:100%; height:339px; position:absolute; background:#eaf1f1; top:30px; left:0px;">
                    ...
                    <table align="center" id=bordeFino>
                        <tr class="cabecera-tabla">
                            <td id=bordeFino width="120px">COD. BARRA</td>
                            <td id=bordeFino width="450px">DESCRIPCION</td>
                            <td id=bordeFino width="60px">STOCK</td>
                            <td id=bordeFino width="100px">PRE. VENTA</td>
            ...
            ';
                ...
                $sql = 'SELECT * FROM articulos'.$criterio;
                $resultado = mysqli_query($conex, $sql);
                $total_registros = mysqli_num_rows($resultado);

                $sql = "SELECT * FROM articulos ".$criterio." ORDER BY descripcion LIMIT $inicio, $numer_reg";
                $resultado = mysqli_query($conex, $sql);
                $numero_registros = mysqli_num_rows($resultado);
                foreach ($resultado as $fila) {
                    echo "<tr class='detalle-tabla'>";
                        echo "<td id=bordeFino>".$fila['codbarra']."</td>";
                        echo "<td id=bordeFino>".$fila['descripcion']."</td>";
                        echo "<td id=bordeFino align=right>".$fila['stock']."</td>";
                        echo "<td id=bordeFino align=right>".number_format($fila['preventa'], 0, ",", ".")."</td>";
                        echo "<td id=bordeFino align=center>".$fila['idarticulo']."</td>";
